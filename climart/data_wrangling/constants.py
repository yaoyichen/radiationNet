...
TRAIN_YEARS = list(range(1979, 1991)) + list(range(1994, 2005)) + [2005,2007]
VAL_YEARS = [2005, 2006]
...
ALL_YEARS = TRAIN_YEARS + VAL_YEARS + TEST_YEARS + OOD_HISTORIC_YEARS + OOD_FUTURE_YEARS

# H5_DIR = "/Users/yaoyichen/dataset/radiation/RT_DATA"
# H5_DIR = "/mnt_det/eason.yyc/radiation/RT_DATA"
H5_DIR = "/home/eason.yyc/data/radiation/RT_DATA"
